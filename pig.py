...
def get_player(identity, type_of_player):
...
def decide(roll_die_value, player):
    return player.decide(roll_die_value)


def roll_game_die(player):
...
class TimedGameProxy(Game):
    def __init__(self, playerA, playerB, player1, player2):
            ...
            for player in self.listOfPlayers:
                ...
                while result == 3:
                    ...
                    if (60 - (time.time() - self.startTime)) < 0:
                        ...
                        resulting_face = roll_game_die(player)
                    ...
                    if (60 - (time.time() - self.startTime)) < 0:
                        ...
                        result = decide(resulting_face, player)
                        ...
                        if (60 - (time.time() - self.startTime)) < 0:
                            ...
                            if result == 2:
                                ...
                                print("ALERT: Cannot add %i points since" 
                                      " game is already over by %f second" 
...
def main():
    global player1_choice, player2_choice, timed_game
    ...
    PlayerFactory()
    player1 = get_player(1, player1_choice)
    player2 = get_player(2, player2_choice)
